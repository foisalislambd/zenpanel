    ...
    <template v-if="users.length > 0">
          ...
          <div class="flex items-start justify-between gap-3">
            ...
            <span
              :class="[
                ...
                providerStyles[user.authProvider] ?? 'bg-gray-100 text-gray-600 dark:bg-gray-800',
              ]"
            >
              {{ user.authProvider }}
            </span>
      ...
      <div class="admin-scrollbar hidden overflow-x-auto md:block">
        <table class="w-full min-w-[600px] text-left text-sm">
          <thead>
            <tr
              class="border-b border-gray-200 bg-gray-50/50 dark:border-gray-800 dark:bg-white/[0.02]"
            >
