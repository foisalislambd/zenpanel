...
import { CalendarDays, FolderKanban, Settings } from "lucide-vue-next";
...
const name = computed(() => auth.admin?.username ?? adminConfig.brand.name);
</script>
...
<template>
  ...
  >
    ...
    <div class="relative flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
      <div class="min-w-0">
        <p class="text-sm font-medium text-brand-100">{{ getGreeting() }}, {{ name }}</p>
